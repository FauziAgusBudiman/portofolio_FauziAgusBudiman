...
@section('page_title', 'Tambah Riwayat Pengalaman')
    ...
    <div class="col-xl-8">
        <div class="admin-card">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h3 class="h6 fw-bold text-white mb-0">Formulir Pengalaman Baru</h3>
            ...
            <form action="{{ route('admin.experiences.store') }}" method="POST">
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-7">
                        ...
                        <input type="text" id="company" name="company" class="admin-input" placeholder="Contoh: MTs Tanwiriyyah, Cianjur" value="{{ old('company') }}" required>
                    </div>

                    <div class="col-md-5">
                        <label for="type" class="admin-form-label">Tipe Pengalaman</label>
                        <input type="text" id="type" name="type" class="admin-input" placeholder="Kerja Praktik / Full-Time / Freelance" value="{{ old('type') }}">
                    </div>
                </div>
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-7">
                        ...
                        <input type="text" id="role" name="role" class="admin-input" placeholder="Contoh: Web Developer / Kerja Praktik" value="{{ old('role') }}" required>
                    </div>

                    <div class="col-md-5">
                        <label for="period" class="admin-form-label">Periode Waktu *</label>
                        <input type="text" id="period" name="period" class="admin-input" placeholder="Contoh: Jul 2025 - Nov 2025" value="{{ old('period') }}" required>
                    </div>
                </div>

                <div class="mb-3">
                    <label for="description" class="admin-form-label">Deskripsi Pekerjaan & Tanggung Jawab *</label>
                    <textarea id="description" name="description" rows="5" class="admin-textarea" placeholder="Jelaskan peran, tugas, dan kontribusi Anda..." required>{{ old('description') }}</textarea>
                </div>
                ...
                <div class="text-end pt-3 border-top border-secondary border-opacity-25">
                    <button type="submit" class="btn btn-info text-dark fw-bold px-4 py-2">
                        <i class="bi bi-plus-circle me-1"></i> Simpan Pengalaman
                    </button>
                </div>
            </form>
        </div>
